...
<div class={`bg-${color} mx-0 h-[9in] w-[4in] rounded-sm py-1.5 text-white`}>
	<div class="flex h-fit">
		<div class="flex w-1/3 px-2" />
		<div class="w-2/3">
			<div class="flex border-b-2 border-white text-xs">
				<div class="py-0.5">
					<p>United States</p>
			...
			<div class="border-b-2 border-white py-0.5 text-xs">
				<p>{shortTitle}</p>
			</div>
		</div>
	</div>
